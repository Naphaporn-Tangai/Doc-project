...
Template.hpcapprovecgex.onCreated(function init() {

    $('body').addClass('waitMe_body');
    var elem = $('<div class="waitMe_container img"><div style="background:url(\'img.svg\')"></div></div>');
    $('body').prepend(elem);
})
Template.hpcapprovecgex.onRendered(function() {
...
Template.hpcapprovecgex.helpers({
    user() {
...
Template.hpcapprovecgex.events({
    'change #yearselect' () {
