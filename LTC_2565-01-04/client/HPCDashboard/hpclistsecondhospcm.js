...
Template.hpclistcmsecondhosp.onCreated(function init() {

    $('body').addClass('waitMe_body');
    var elem = $('<div class="waitMe_container img"><div style="background:url(\'img.svg\')"></div></div>');
    $('body').prepend(elem);
})
Template.hpclistcmsecondhosp.onRendered(function () {
...
Template.hpclistcmsecondhosp.helpers({
    user() {
        return Session.get('user').NAME
    },
    list() {
        //console.log(Session.get('hpclistcmsecondhosp'))
        return Session.get('hpclistcmsecondhosp')
    },
    count() {
        if (Session.get('hpclistcmsecondhosp')) {
            return Session.get('hpclistcmsecondhosp').length;
        }
    },
    profile() {
...
Template.hpclistcmsecondhosp.events({
    'click #cancel'() {
    ...
    'click #check'() {
        ...
        //     Session.set('hpclistcmsecondhosp', result)
        // });
...
function refreshfunc(ZONE) {
    Meteor.call('ZonelistSecondaryHosp', ZONE, function (error, result) {
