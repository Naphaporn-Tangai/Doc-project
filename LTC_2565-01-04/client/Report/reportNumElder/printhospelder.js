...
Template.printhospelder.onRendered(function () {

    var start = +new Date();
    
    var data = Session.get('sendToNumHospElderPrint').graph
...
Template.printhospelder.helpers({
    zonerep1() {
        return _.sortBy(Session.get('sendToNumHospElderPrint').table, o => o._id)
    },
    sumCMCG() {
        var sum = Session.get('sendToNumHospElderPrint').table
