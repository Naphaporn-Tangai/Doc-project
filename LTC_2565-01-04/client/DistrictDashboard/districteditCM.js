...
//     path: '/uploads/photos'
// });
Template.districteditcm.onCreated(function init() {

    $('body').addClass('waitMe_body');
    var elem = $('<div class="waitMe_container img"><div style="background:url(\'img.svg\')"></div></div>');
    $('body').prepend(elem);
})
Template.districteditcm.onRendered(function () {
...
Template.districteditcm.helpers({
    showname() {
...
Template.districteditcm.events({
    "change #companyName"() {
    ...
    "click #save"() {
        ...
        if (check_service && $("#subdistrict_name").val() && $('#subdistrict_name') && $("#pid").val() && $("#titleName").val() && $("#FName").val() && $("#LName").val() && $("#sex").val() && $("#tel").val() && $("#email").val() && $("#trainingBy").val() && $("#birthDate").val() && $("#trainingDate").val()) {
            ...
            //console.log(Session.get('Fe_persontype'));
            //console.log(Session.get('Fe_LICENCE_NUMBER'));
